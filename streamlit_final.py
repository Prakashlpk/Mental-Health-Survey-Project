...
def load_model_and_scaler():
    try:
        model = keras.models.load_model(r'D:\GUVI\Mental_health_survey\env\mental_health_survey_final.keras')
        scaler = load(r"D:\GUVI\Mental_health_survey\env\scaler.save")
        feature_cols = load(r"D:\GUVI\Mental_health_survey\env\feature_cols.save")
...
def load_and_preprocess_test_data():
    try:
        df_test = pd.read_csv(r'D:\GUVI\Mental_health_survey\env\final_test_new.csv')
        return df_test
    except Exception as e:
